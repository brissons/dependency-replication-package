...
public class UniqueForks {
    ...
    private static void indentify() throws Exception {
        ...
        String file1 = "ReposFork_remain75.xlsx";
        ...
        for (int a = 0; a < FILES.length; a++) {
            ...
            while (count < numbers) {
                ...
                List<String> shaaList = Pick_GeneralNext.pick(path + FILES[a], count, 11, 2);
                ...
                datas = new Object[]{"MLP", "FP", "Created_at", "FirstCom", "LastCom", "ComitsBefore", "ComitsAfter", "UNIQUE", "Active_days", "Shaas","UniqueMessage"
                ...
                for (int b = 0; b < nameList.size(); b++) {
                    ...
                    double commitsBefore = 0;
                    for (int i = 0; i < shaList_1.size(); i++) {
                        if ( DateOperations.compareDates(dateList_1.get(i), createList.get(b))) {
                            commitsBefore ++;
                        }
                    }
                    ...
                    for (int c = 0; c < shaList_3.size(); c++) {
                        ...
                        if (c_shas == 0) {
                            ...
                            sha_message = sha_message.concat(messageList_3.get(c) + "/");
                        }
                    ...
                    if (total_unique > 0) {
                        ...
                        datas = new Object[]{"", nameList.get(b), createList.get(b), fDate, lDate,commitsBefore, Double.parseDouble(shaList_3.size() + ""), total_unique, fdays, sha_collections, sha_message};
                        allobj.add(datas);
